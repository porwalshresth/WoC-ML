This is my first college project - A Machine Learning Library built from scratch - in Python language using only the external libraries - NumPy and Pandas only.
The following alogorithms are implemented from the Scratch:
Linear Regression,
